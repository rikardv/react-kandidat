    ...
    return loading ? (
        ...
        >
            ...
            >
                ...
                >
                    <Info text="Grafen visar procentuella antalet som klarat kurserna vid resultatrapporteringarna. Välj kurser från filtreringen till höger för att visa data för flera kurser." />
                    <Help text="Dra muspekaren över graferna för få mer infomation om dem." />
                    <CardContent>
