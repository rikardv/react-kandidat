...
const Omtenta = (props) => {
  ...
  return loading ? (
    ...
    >
      <Help text='L�gg till fler kurser i filtret till h�ger f�r att j�mf�ra hur m�nga omtentor som g�rs i varje kurs.' />
      <AnalysInfo
      ...
      <Grid style={{ backgroundColor: 'white', width: '90%', height: '500px' }}>
        <Info text='Grafen visar hur m�nga omtentor det kr�vs f�r att klara en kurs. Datan visas i procent.' />
